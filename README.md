...
Ersetze in den folgenden Befehlen `DEIN_USER/DEIN_REPO` durch dein GitHub-Repository.

```text
https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main
```
...
```text
wget https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main/init.lua init
init pocket bergwerk_01 basis_01 https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main
```
...
```text
wget https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main/init.lua init
init koordinator bergwerk_01 basis_01 https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main
```
...
```text
wget https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main/init.lua init
init bergbau bergwerk_01 bergbau_01 basis_01 https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main
```
...
```text
wget https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main/init.lua init
init graben bergwerk_01 graben_01 basis_01 https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main
```
...
```text
wget https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main/init.lua init
init handwerk bergwerk_01 handwerk_01 basis_01 https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main
```
...
```text
wget https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main/init.lua init
init holzfaeller bergwerk_01 holz_01 basis_01 https://raw.githubusercontent.com/DEIN_USER/DEIN_REPO/main
```
